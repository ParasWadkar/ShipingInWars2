...
function setup() {
	...
	World.add(world, packageBody);
	 ...
	 boxPart1 = Bodies.rectangle(375,650,200,20,{restitution:0.1,isStatic:true});
	 World.add(world,boxPart1);

	 boxPart2 = Bodies.rectangle(375,650,200,20,{restitution:0.1,isStatic:true});
	 World.add(world,boxPart1);

	 boxPart3 = Bodies.rectangle(375,650,200,20,{restitution:0.1,isStatic:true});
	 World.add(world,boxPart1);
	//Create a Ground
